...
public class PopulationBulkRepository {
    ...
    public void saveAll(List<Population> populationList){
        ...
        String sql = "INSERT INTO population (" +
                ...
                "sunday_population, hour_0_6, hour_6_11, hour_11_14, hour_14_17, hour_17_21, hour_21_24) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        jdbcTemplate.batchUpdate(sql,
                ...
                (PreparedStatement ps, Population population) -> {
                    ...
                    ps.setLong(24, population.getTown().getId()); // 여기서 town이 객체라면 getId() 같은 메소드로 ID를 가져와야 함
                });
