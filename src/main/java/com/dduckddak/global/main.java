...
//                    .age10sPopulationOfMale(parseLongFromObject(regident.get("mag_10_repop_co")))
//                    .age10sPopulationOfFemale(parseLongFromObject(regident.get("fag_10_repop_co")))
//                    .age20sPopulation(parseLongFromObject(regident.get("agrde_20_repop_co")))
//                    .age20sPopulationOfMale(parseLongFromObject(regident.get("mag_20_repop_co")))
//                    .age20sPopulationOfFemale(parseLongFromObject(regident.get("fag_20_repop_co")))
//                    .age30sPopulation(parseLongFromObject(regident.get("agrde_30_repop_co")))
//                    .age30sPopulationOfMale(parseLongFromObject(regident.get("mag_30_repop_co")))
//                    .age30sPopulationOfFemale(parseLongFromObject(regident.get("fag_30_repop_co")))
//                    .age40sPopulation(parseLongFromObject(regident.get("agrde_40_repop_co")))
//                    .age40sPopulationOfMale(parseLongFromObject(regident.get("mag_40_repop_co")))
//                    .age40sPopulationOfFemale(parseLongFromObject(regident.get("fag_40_repop_co")))
//                    .age50sPopulation(parseLongFromObject(regident.get("agrde_50_repop_co")))
//                    .age50sPopulationOfMale(parseLongFromObject(regident.get("mag_50_repop_co")))
//                    .age50sPopulationOfFemale(parseLongFromObject(regident.get("fag_50_repop_co")))
//                    .age60sAndMorePopulation(parseLongFromObject(regident.get("agrde_60_above_repop_co")))
//                    .age60sPopulationOfMale(parseLongFromObject(regident.get("mag_60_above_repop_co")))
//                    .age60sPopulationOfFemale(parseLongFromObject(regident.get("fag_60_above_repop_co")))
//                    .town(town)
//                    .build();
//
//            populationList.add(population);
...
//                    .age10sPopulationOfMale(parseLongFromObject(workingPopulationObj.get("mag_10_wrc_popltn_co")))
//                    .age10sPopulationOfFemale(parseLongFromObject(workingPopulationObj.get("fag_10_wrc_popltn_co")))
//                    .age20sPopulation(parseLongFromObject(workingPopulationObj.get("agrde_20_wrc_popltn_co")))
//                    .age20sPopulationOfMale(parseLongFromObject(workingPopulationObj.get("mag_20_wrc_popltn_co")))
//                    .age20sPopulationOfFemale(parseLongFromObject(workingPopulationObj.get("fag_20_wrc_popltn_co")))
//                    .age30sPopulation(parseLongFromObject(workingPopulationObj.get("agrde_30_wrc_popltn_co")))
//                    .age30sPopulationOfMale(parseLongFromObject(workingPopulationObj.get("mag_30_wrc_popltn_co")))
//                    .age30sPopulationOfFemale(parseLongFromObject(workingPopulationObj.get("fag_30_wrc_popltn_co")))
//                    .age40sPopulation(parseLongFromObject(workingPopulationObj.get("agrde_40_wrc_popltn_co")))
//                    .age40sPopulationOfMale(parseLongFromObject(workingPopulationObj.get("mag_40_wrc_popltn_co")))
//                    .age40sPopulationOfFemale(parseLongFromObject(workingPopulationObj.get("fag_40_wrc_popltn_co")))
//                    .age50sPopulation(parseLongFromObject(workingPopulationObj.get("agrde_50_wrc_popltn_co")))
//                    .age50sPopulationOfMale(parseLongFromObject(workingPopulationObj.get("mag_50_wrc_popltn_co")))
//                    .age50sPopulationOfFemale(parseLongFromObject(workingPopulationObj.get("fag_50_wrc_popltn_co")))
//                    .age60sAndMorePopulation(parseLongFromObject(workingPopulationObj.get("agrde_60_above_wrc_popltn_co")))
//                    .age60sPopulationOfMale(parseLongFromObject(workingPopulationObj.get("mag_60_above_wrc_popltn_co")))
//                    .age60sPopulationOfFemale(parseLongFromObject(workingPopulationObj.get("fag_60_above_wrc_popltn_co")))
//                    .town(town)
//                    .build();
//
//            populationList.add(population);
